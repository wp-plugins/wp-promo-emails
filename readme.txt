...
WP Promo Emails plugin sends content rich HTML emails/newsletters to registered users. WP Promo Emails plugin users can view their total user base, and email users. This plugin is great for those who seek an easy way to send content rich newsletters that can contain vibrant graphics, video and other dynamic content.
...
5. (Optional)Send test emails.
6. Support for localization or internationalization (Translators Welcome)
7. Clean uninstall process, doesnt leave unwanted data in your database
...
= Contributing =
WP Promo eMails is also available on [cbfreeman](http://cbfreeman.com/wp-promo-emails/).
