...
5. Send test emails.
6. Manage, edit and view total eMail sending history
7. (Premier)Resend old stored eMails saved in your archives
8. WP Promo Emails Dashboard Widget with current eMail Stats
9. Support for localization or internationalization (Translators Welcome)
10. Clean uninstall process, doesnt leave unwanted data in your database
...
3. Sample Dashboard section is provided with WP Promo eMails.
